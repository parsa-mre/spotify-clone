...
const Login = () => {
    ...
    return (
        <div className="w-full bg-gradient-to-b from-eerie from-1% to-night to-80% h-[100vh] flex-col flex-1 overflow-auto">
            <div className="bg-black h-20 flex-row">
                <svg
                    role="img"
                    viewBox="0 0 78 24"
                    aria-label="Spotify"
            ...
            <div className=" h-[700px] flex items-center justify-evenly ">
                <div className="h-[600px] w-full sm:w-[640px] bg-black rounded-md py-6 px-4 flex flex-col items-center">
                    <h1 className="pt-12 mb-10 text-white text-center text-4xl font-extrabold">
                        Log in to Spotify
                    </h1>
                    <form
                    ...
                    <div className="my-10 px-10 h-[0.5px] w-[95%] sm:w-[80%] bg-silver "></div>
